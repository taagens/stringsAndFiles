    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                //d.CreateSubdirectory(@"Sub\MySub");
            }
            catch (IOException e)
            {
                Console.WriteLine(e.Message);
            ...
            FileInfo fi = new FileInfo(@"C:\Users\taago\Documents\Praktikalt\2017\Myprogram.txt");
           // FileStream fstr = fi.Create();
            ...
            w.WriteLine("Files renamed " + counter);
            w.Write(w.NewLine);
            ...
            Console.WriteLine();
            Console.WriteLine("tehtud " + counter + " Xml faili" );
